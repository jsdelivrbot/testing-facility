...
const UIControler = (() => {
    ...
    function displayMovieListItem(movie) {
        const containerForMovies = document.querySelector(DOMStrings.containerMovieList);
    ...
    function displayProgramListItem(program) {
        const containerForPrograms = document.querySelector(DOMStrings.containerProgramList);
    ...
    function displayAddedMovie(data) {
        const movieSelectElement = document.getElementById(DOMStrings.displayAddedMovie);
    ...
    function displayAddedProgram(data) {
        const programSelectElement = document.getElementById(DOMStrings.displayAddedProgram);
    ...
    function displayMovieError({ title, length, genre }) {
        ...
        let containerForError = document.querySelector(DOMStrings.containerMovieError);
    ...
    function displayProgramError() {
        ...
        let containerForError = document.querySelector(DOMStrings.containerProgramError);
        containerForError.textContent = error;
    }
    ...
    function joinMovieAndProgram(data) {
        ...
        data.programs[programSelectElement.value].listOfMovies.push(data.movies[movieSelectElement.value]);
    }

    function renderMovieProgramJoint() {
        const movieField = document.getElementById(DOMStrings.displayAddedMovie);
        const programField = document.getElementById(DOMStrings.displayAddedProgram);
        const displayField = document.querySelector(DOMStrings.displayMovieToProgram);

        let paragElement = document.createElement('p');
        let result = `${movieField.textContent} has been added to: ${programField.textContent} program!`;
...
const mainControler = ((dataCtrl, UICtrl) => {
    ...
    function setupEventListeners() {
        ...
        const { buttonAddMovie, buttonAddProgram, buttonAddMovieToProgram } = UICtrl.getDOMStrings();
        ...
        document.querySelector(buttonAddProgram).addEventListener('click', ctrlAddProgramItem);

        document.querySelector(buttonAddMovieToProgram).addEventListener('click', ctrlAddMovieToProgram);
    }
